...
Readme taken from FAST repo (<a href="https://github.com/4nnina/fair_seq_task_assignment">https://github.com/4nnina/fair_seq_task_assignment</a>).

Before reading the following informations, remember to read `backend/FAST/dataset` and `backend/FAST/src`.
